...
> **Fork of [a16z-infra/ai-town](https://github.com/a16z-infra/ai-town)** (forked at upstream commit `2693ed6`).
> Architecture-level rewrite of the agent loop, lives on `main`. Original README preserved verbatim at the bottom.
...
净改动 ~455 行 / 10 文件改 + 4 新文件。完整 commit 历史从 `2693ed6` 之后开始读,共 11 个逻辑 commit。
